...
class AddExternalMedia {  
    ...
    function __construct() {  
		...
		load_plugin_textdomain( 'aem', false, basename( dirname( __FILE__ ) ) . '/languages/' );
	...
	function media_view_strings($strings, $post){
		$strings['AddExternalMediaMenuTitle'] = __( 'Add External Media', 'aem' );
		$strings['AddExternalMediaButton'] = __( 'Add to library', 'aem' );
		return $strings;
	}
